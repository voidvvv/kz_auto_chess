...
| 文档                                                                                                            | 说明 |
|---------------------------------------------------------------------------------------------------------------|------|
| [@.Codex/docs/architectural_patterns.md](.Codex/docs/architectural_patterns.md)                             | 架构模式、设计决策、约定 |
| [@.Codex/docs/core_flow.md](.Codex/docs/core_flow.md)                                                       | 核心流程图解（PlantUML） |
| [@.Codex/skills/kz-autochess-patterns.md](.Codex/skills/kz-autochess-patterns.md)                           | 代码模式与工作流详细指南 |
| [@.Codex/skills/kz-autochess-code-guidelines/SKILL.md](.Codex/skills/kz-autochess-code-guidelines/SKILL.md) | 编码指南与常见问题 |
